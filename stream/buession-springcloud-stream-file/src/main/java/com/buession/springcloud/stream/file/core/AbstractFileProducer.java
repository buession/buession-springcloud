 ...
 * @since 3.0.0
 */
public abstract class AbstractFileProducer<M, S extends Source> extends AbstractProducer<M, S>
		implements FileProducer<M> {
	 ...
	 * 		消息源 {@link Source}
	 */
	public AbstractFileProducer(final S source) {
		super(source);
	}
