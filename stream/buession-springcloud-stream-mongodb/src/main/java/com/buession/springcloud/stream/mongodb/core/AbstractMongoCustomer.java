 ...
 * @since 3.0.0
 */
public abstract class AbstractMongoCustomer<M, S extends Sink> extends AbstractCustomer<M, S>
		implements MongoCustomer<M> {
	 ...
	 * 		消息消费 {@link Sink}
	 */
	public AbstractMongoCustomer(final S sink) {
		super(sink);
	}
