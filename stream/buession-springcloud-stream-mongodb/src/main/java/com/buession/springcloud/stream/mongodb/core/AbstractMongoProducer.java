 ...
 * @since 3.0.0
 */
public abstract class AbstractMongoProducer<M, S extends Source> extends AbstractProducer<M, S>
		implements MongoProducer<M> {
	 ...
	 * 		消息源 {@link Source}
	 */
	public AbstractMongoProducer(final S source) {
		super(source);
	}
